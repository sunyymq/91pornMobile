...
//网站名字
$siteName='azuretouch tube';

//youtube API V3 KEY:

$key='AIzaSyAq7A10NWUyusnQFUC7TuQnrvlRCt5sd8Y';
...
$footer='<footer class="w3-container w3-red w3-center" style="width: 100%;bottom: 0px;">
            <p>©Development by <a href="https://www.azuretouch.net/" target="_blank">AZURETOUCH</a></p>
        </footer>
        </body>
</html>';
...
switch (@$_SERVER['PATH_INFO']) {
    ...
    case '/searchdata':
        $data='';
        $videodata=get_search_video(urlencode($_GET['q']),$key,'video','relevance','jp',$_GET['pid']);
...
echo '<script>
    ...
    default:
        ...
        <h3>#时下流行#</h3>
            <div class="tj">';
            $home_data=get_trending($key,'25','','jp');
